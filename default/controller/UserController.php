...
require_once str_replace('\\', '/', __DIR__."/")."../../EntityMgr.php";
require_once str_replace('\\', '/', __DIR__."/")."../../abstract/BaseController.php";
require_once str_replace('\\', '/', __DIR__."/")."../model/User.php";
